...
class ScanIpDoSAttaque
{
    ...
    static void RealizarAtaqueDoS()
    {
        ...
        Console.WriteLine("Introduzca la cantidad de hilos que prefiera para ejecutar el at@que.");
        ...
        for (int i = 0; i < numerohilo; i++)
        {
            ...
            Thread thread = new Thread(() => SendRequests(targetIp, targetaPuerto, threadNumber, targeta2Url));
            thread.Start();
        }
    }
